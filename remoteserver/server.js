...
return outputer;
  ...
  {type:new GraphQLList(films),args: {_id:{type : GraphQLString}},  
   resolve: async (parent, args) => { const outputer =  findOne(args, conn.collection("films"));
  ...
  {type:new GraphQLList(species),args: {_id:{type : GraphQLString}},  
   resolve: async (parent, args) => { const outputer =  findOne(args, conn.collection("species"));
  ...
  {type:new GraphQLList(planets),args: {_id:{type : GraphQLString}},  
   resolve: async (parent, args) => { const outputer =  findOne(args, conn.collection("planets"));
  ...
  {type:new GraphQLList(people),args: {_id:{type : GraphQLString}},  
   resolve: async (parent, args) => { const outputer =  findOne(args, conn.collection("people"));
   return outputer;}}} }); 
